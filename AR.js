...
async function loadAnnualReports() {
  ...
  try {
    ...
    if (!data || data.length === 0) {
      ...
      noNewsMsg.textContent = "No annual reports available.";
      return;
    }
    ...
    noNewsMsg.style.display = "block";
    noNewsMsg.textContent = "Failed to load annual reports.";
  }
}
