...
async function loadPaipa() {
  ...
  try {
    ...
    if (!data || data.length === 0) {
      ...
      noNewsMsg.textContent = "No PAIPA documents available.";
      return;
    }
    ...
    spinner.style.display = "none";
    console.error("Error fetching PAIPA documents:", err);
    noNewsMsg.style.display = "block";
    noNewsMsg.textContent = "Failed to load PAIPA documents.";
  }
}

document.addEventListener("DOMContentLoaded", loadPaipa);
